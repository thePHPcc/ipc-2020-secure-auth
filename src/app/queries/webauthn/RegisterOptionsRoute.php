...
class RegisterOptionsRoute extends ProtectedGetRoute {
    ...
    protected function matches(Request $request): bool {
        return $request->url()->equals(new Url('/webauthn/register/options'));
    }

    protected function buildQuery(GetRequest $request): Query {
        return $this->factory->createWebAuthnRegisterOptionsQuery();
    }
